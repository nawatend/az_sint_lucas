            ...
            <div className="game__body--body">
                <svg className="whole__body" xmlns="http://www.w3.org/2000/svg" width="330.576" height="876.548" viewBox="0 0 330.576 876.548">
                    <g transform="translate(-286.535 -142.452)"><ellipse cx="81.5" cy="29.5" rx="81.5" ry="29.5" transform="translate(371 960)" fill="#205455" />
                        ...
                        {/* stomach */}
                        <g className="organs organs__stomach" data-organ="stomach" onClick={(e) => selectOrgan(e)}>
                        ...
                        {/* small intestine */}
                        <g className="organs organs__intestine--small" data-organ="small_intestine">
                        ...
                        {/* large intestine */}
                        <g className="organs organs__intestine--large" data-organ="large_intestine">
                        ...
                        {/* lungs */}
                        <g className="organs organ__lungs" data-organ="lungs">
                        ...
                        {/* heart */}
                        <g className="organs organs__heart" data-organ="heart">
                        ...
                        {/* liver */}
                        <g className="organs organs__liver" data-organ="liver">
                        ...
                        {/* kidney */}
                        <g className="organs organs__kidney" data-organ="kidney">
                        ...
                        {/* bladder*/}
                        <g className="organs organs__bladder" data-organ="bladder">
            ...
            <div className="game__body--labels">
                <svg className="whole__body--labels" xmlns="http://www.w3.org/2000/svg" width="661" height="715" viewBox="0 0 661 715">
                    <g transform="translate(-678 -125)">
                        ...
                        {/* stomach */}
                        <g className="organs__labels " data-organ="stomach" onClick={(e) => selectLabel(e)} transform="translate(-22 -140)">
                        ...
                        {/* small intestine */}
                        <g className="organs__labels " data-organ="small_intestine" transform="translate(-46 -129)">
                        ...
                        {/* large intestine */}
                        <g className="organs__labels " data-organ="large_intestine" transform="translate(-9 -44)">
                        ...
                        {/* lungs */}
                        <g className="organs__labels " data-organ="lungs">
                        ...
                        {/* heart */}
                        <g className="organs__labels " data-organ="heart">
                        ...
                        {/* liver */}
                        <g className="organs__labels " data-organ="liver" transform="translate(86 -58)">
                        ...
                        {/* kidney */}
                        <g className="organs__labels " data-organ="kidney" transform="translate(30 -30)">
                        ...
                        {/* bladder*/}
                        <g className="organs__labels " data-organ="bladder" transform="translate(21 -210)">
