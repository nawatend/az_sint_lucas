...
export default function BodyGame() {
    ...
    let checkOrgan = (organ) => {
        const inArray = matchOrgans.indexOf(organ)
        return (inArray === -1) ? false : true
    }


    useEffect(() => {

        if (matchOrgans.length === 8) {
            setGameOver(true)
            console.log('ENDDD of game')
        }

    }, [labelSelected, matchOrgans, organSelected])
            ...
            <div className="game__body--body">
                <svg className="whole__body" xmlns="http://www.w3.org/2000/svg" width="330.576" height="876.548" viewBox="0 0 330.576 876.548">
                    <g transform="translate(-286.535 -142.452)"><ellipse cx="81.5" cy="29.5" rx="81.5" ry="29.5" transform="translate(371 960)" fill="#205455" />
                        ...
                        {/* face */}
                        <g className="face">
                            <path d="M5362.411,1671.5s24,25.912,50.268,0" transform="translate(-4936 -1401)" fill="none" stroke="#c69191" strokeLinecap="round" strokeWidth="3" /><path d="M132.582,98.074c0,4.337-1.9,7.662-3.695,8.064a1.337,1.337,0,0,1-.353.048c-1.928,0-4.064-3.47-4.064-8.112,0-4.064,1.622-7.2,3.325-7.936a.7.7,0,0,0,.08-.016,1.585,1.585,0,0,1,.386-.048,2.1,2.1,0,0,1,.707-.016C130.751,90.54,132.582,93.8,132.582,98.074Z" transform="translate(361.833 108.854)" /><path d="M104.276,112.193a1.223,1.223,0,0,1-.938,1.458c-.093.009-.176.019-.26.019a1.221,1.221,0,0,1-1.2-.966,14.378,14.378,0,0,0-5.3-7.856,2.365,2.365,0,0,0-1.857-.39c-4.067.882-6.5,5.284-7.2,7.819a1.228,1.228,0,0,1-2.368-.65c.13-.427,2.721-8.181,9.035-9.555a4.8,4.8,0,0,1,3.724.724C101.992,105.424,104.081,111.274,104.276,112.193Z" transform="translate(356.973 127.358)" fill="#c69191" /><path d="M69.144,98.4c0,4.659-2.731,7.9-5.173,8-1.928.1-5.462-3.952-5.462-8.594,0-4.626,3.534-7.614,5.462-7.614C66.879,89.758,69.144,93.774,69.144,98.4Z" transform="translate(354.836 108.929)" />
                        </g>
                        ...
                        <g className={"organs organs__kidney " + (checkOrgan("kidney") ? "disable" : "")} data-organ="kidney" onClick={(e) => selectOrgan(e)}>
                            <path d="M103.1,341.436c.7,3.891-8.231,20.377-15.716,0s14.969-27.161,19.465-21.133S101.038,330.057,103.1,341.436Z" transform="translate(321.436 231.439)" fill="#7b5aa2" stroke="#633e91" strokeMiterlimit="10" strokeWidth="2" /><path d="M100.086,331.17s17.943,22.105,11.318,42.636-18.845,40.23-17.661,47.283c.9,5.389,10.923,5.248,17.055,9.062" transform="translate(324.629 235.075)" fill="none" stroke="#633e91" strokeMiterlimit="10" strokeWidth="2" /><path d="M145.618,329.81s-17.942,22.105-11.318,42.636,18.845,40.23,17.661,47.283c-.9,5.389-15.039,6.989-21.17,10.8" transform="translate(339.832 234.694)" fill="none" stroke="#633e91" strokeMiterlimit="10" strokeWidth="2" /><path d="M142.213,341.436c-.7,3.891,8.231,20.377,15.716,0S142.96,314.274,138.464,320.3,144.271,330.057,142.213,341.436Z" transform="translate(342.504 231.439)" fill="#7b5aa2" stroke="#633e91" strokeMiterlimit="10" strokeWidth="2" />
                        </g>
                ...
                <svg className="whole__body--labels" xmlns="http://www.w3.org/2000/svg" width="661" height="715" viewBox="0 0 661 715">
                    <g transform="translate(-678 -125)">
                        ...
                        <g className={"organs__labels " + (checkOrgan("stomach") ? " disable__label" : "")} data-organ="stomach" onClick={(e) => selectLabel(e)} transform="translate(-22 -140)">
                            ...
                            <text transform="translate(1195 316)" fill="#fff" fontSize="51" fontFamily="Laca-Bold, Laca" fontWeight="700"><tspan x="-61.761" y="0">maag</tspan>
                            </text>
                        ...
                        <g className={"organs__labels " + (checkOrgan("heart") ? " disable__label" : "")} data-organ="heart" onClick={(e) => selectLabel(e)} >
                            ...
                            <text transform="translate(785 196)" fill="#fff" fontSize="51" fontFamily="Laca-Bold, Laca" fontWeight="700"> <tspan x="-48.654" y="0">hart</tspan></text>
