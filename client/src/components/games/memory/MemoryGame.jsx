...
export class Memory extends Component {
    ...
    createGameContainer = () => {
        ...
        for (let i = 0; i < amountCards; i++) {
            const div = `<div id="${i + count}" class="memory-card" data-framework="${cardsArrayRandom[i]}"> <img class="front-face" src="${process.env.PUBLIC_URL}/images/games/memory/${cardsArrayRandom[i]}.png" alt="${cardsArrayRandom[i]}" /> <div class="back-face" style="background-image: url(${process.env.PUBLIC_URL}/svgs/games/memory/back.svg);"></div> </div>`;
